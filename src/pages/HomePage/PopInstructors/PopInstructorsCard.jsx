...
const PopInstructorsCard = ({ instructors }) => {
    ...
    return (
        <div>
            {/* <div class="card w-72 mx-auto bg-white  shadow-xl hover:shadow">
            <img class="w-32 mx-auto rounded-full -mt-20 border-8 border-white" src={photoURL} alt=""/>
                <div class="text-center mt-2 text-3xl font-medium">{totalStudentsEnrolled}</div>
                <div class="text-center mt-2 font-light text-sm">{instructorName}</div>
